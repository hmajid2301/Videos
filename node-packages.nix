...
let
  sources = {
    ...
    "svelte-check-3.7.0" = {
      ...
      version = "3.7.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/svelte-check/-/svelte-check-3.7.0.tgz";
        sha512 = "Va6sGL4Vy4znn0K+vaatk98zoBvG2aDee4y3r5X4S80z8DXfbACHvdLlyXa4C4c5tQzK9H0Uq2pbd20wH3ucjQ==";
      };
    };
    "svelte-hmr-0.15.3" = {
      name = "svelte-hmr";
